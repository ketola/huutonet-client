package ketola.huutonet.service.httpclient;
...
public class OSProtocolSocketFactory
    implements ProtocolSocketFactory
{
        ...
        throws IOException, UnknownHostException
    {
        ...
        {
            log.debug( "createSocket called. host = " + host + ", port = " + port + ", ignoring localAddress = "
                + ( ( localAddress != null ) ? localAddress.toString() : "null" ) + ", ignoring localPort = "
                + localPort );
        }
    ...
    public Socket createSocket( String host, int port )
        throws IOException, UnknownHostException, IOException
    {
